...
function createCard(tagName, innerHTML, classNames, parent) {
...
return false;
  ...
  data.forEach(user => {
    ...
    createCard('p', '<b>' + 'Name: ' + '</b>' + '<h2>' + user.name + '</h2>', ['card__name'], div);
    createCard('p', '<b>' + 'User Name: ' + '</b>' + '<h3>' + user.username + '</h3>', ['card__username'], div);
    createCard('p', '<b>' + 'Email: ' + '</b>' + user.email, ['card__email'], div);
